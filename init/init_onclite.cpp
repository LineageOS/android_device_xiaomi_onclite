...
// Define variants
#define VARIANT_ONE_MODEL "Redmi 7"
#define VARIANT_TWO_MODEL "Redmi Y3"
...
void set_model_prop(const std::string &model) {
...
void set_device_model() {
    ...
    if (hwversion == "1.19.0") {
      set_model_prop(VARIANT_TWO_MODEL);
    } else {
      set_model_prop(VARIANT_ONE_MODEL);
    }
}
